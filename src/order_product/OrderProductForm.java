...
public class OrderProductForm extends JFrame {
    ...
    public void initUI() {
        ...
        c.add(l1);
        l2 = new JLabel("Code");
        l2.setBounds(80, 55, 80, 20);
        c.add(l2);
        tfc = new JTextField();
        tfc.setBounds(165, 55, 150, 20);
        c.add(tfc);

        l3 = new JLabel("Name");
        l3.setBounds(80, 80, 80, 20);
        c.add(l3);
        tfn = new JTextField();
        tfn.setBounds(165, 80, 150, 20);
        c.add(tfn);
        l4 = new JLabel("Qty");
        l4.setBounds(80, 105, 80, 20);
        c.add(l4);
        tfq = new JTextField();
        tfq.setBounds(165, 105, 150, 20);
        c.add(tfq);
        l5 = new JLabel("Unitprice");
        l5.setBounds(80, 130, 80, 20);
        c.add(l5);
        jcb = new JComboBox();
        ...
        l6.setBounds(80, 155, 80, 20);
        c.add(l6);
        ch1 = new JRadioButton("10%");
        ch2 = new JRadioButton("15%");
        ch3 = new JRadioButton("20%");
        ch1.setBounds(165, 155, 60, 20);
        c.add(ch1);
        ch2.setBounds(230, 155, 60, 20);
        c.add(ch2);
        ch3.setBounds(295, 155, 60, 20);
        c.add(ch3);
        g = new ButtonGroup();
        g.add(ch1);
        g.add(ch2);
        ...
        bta.setBounds(80, 180, 80, 20);
        c.add(bta);
        bte.setBounds(180, 180, 80, 20);
        c.add(bte);

        d = new JTextArea();
        jsp = new JScrollPane(d);
        jsp.setBounds(80, 205, 250, 100);
        c.add(jsp);
